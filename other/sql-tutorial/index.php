...
<head>
	...
	<title>SQL Query WebApp by BestJobsLK</title>
	<style>
...
<body>
	<?php echo $login_form; ?>
	<h3><b>Database</b>: <?php echo $host; ?> > <?php echo $db_name; ?> &nbsp;&nbsp;&nbsp;&nbsp;<a href="index.php?logout" class="logout">Log Out</a></a> <span class="appname"><b>BestJobsLK SQL Query WebApp</b> | <small> Version 5</small></span></h3>
...
// 				$_SESSION['history'] = array_unique($_SESSION['history']);
	...
	<form action="index.php" method="post" class="restore">
		...
		<a href="https://bestjobslk.com/downloads/sql/sql-tutorial-sample-db.png" target="_blank">DB Structure</a> 
		&copy; <?php echo '2021'; ?> - <a href="https://www.bestjobslk.com" target="_blank">BestJobsLK.com</a> | 
		<a href="https://www.bestjobslk.com/download.php?v=Ur3q2ruqkC4" target="_blank">Version 5</a> | 
		<a href="https://www.bestjobslk.com/download.php?v=Ur3q2ruqkC4" target="_blank">Download Latest Version</a>
	</form>
<style>
	<?php echo $css; ?>
</style>
